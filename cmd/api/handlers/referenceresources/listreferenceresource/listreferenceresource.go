...
func listReferenceResource(app *application.Application) httprouter.Handle {
	return func(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
		...
		referenceResources, err := referenceResource.ListReferenceResource(app, unique_id)
		...
		dataResponse := newResponse.AddData(referenceResources)
		response, _ := dataResponse.Marshal()
		w.Write(response)
	}
}
...
func Do(app *application.Application) httprouter.Handle {
	return middleware.Chain(listReferenceResource(app), middleware.LogRequest)
}
